<section class="py-24 ">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-12">
            <h2 class="font-manrope text-5xl text-center font-bold text-gray-600 mb-4">Choose your plan </h2>
            <p class="text-gray-500 text-center leading-6 mb-9">7 Days free trial. No credit card required.</p>
            <!--Switch-->
            <div class="mx-auto max-w-xs">
                <h3 class="bg-red-600 w-full text-center py-2 text-white">
                    Handle the subscription without using Livewire
                </h3>
            </div>


            <div class="flex justify-center items-center">
                <label class="min-w-[3.5rem] text-xl relative text-gray-700 mr-4 font-medium">Bill Monthly</label>
        ...
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
            ...
            <div class="flex flex-col mx-auto max-w-sm text-gray-900 rounded-2xl bg-gray-50 p-6 xl:py-9 xl:px-12 transition-all duration-500 hover:bg-gray-100">
                ...
                @if (now()->diffInDays($trialDays, false) > 0)
                <a href="javascript:;" class="py-2.5 px-5 bg-indigo-600 shadow-sm rounded-full transition-all duration-500 text-base text-white font-semibold text-center w-fit mx-auto hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed">
                    You are now in the free trial
                </a>
                @else
                <div class="py-2.5 px-5 bg-gray-300 shadow-sm rounded-full text-base text-gray-700 font-semibold text-center w-fit mx-auto">
            ...
            <div class="flex flex-col mx-auto max-w-sm text-gray-900 rounded-2xl bg-indigo-50 transition-all duration-500 hover:bg-indigo-100 ">
                ...
                <div class="p-6 xl:py-9 xl:px-12">
                    ...
                    <div class="flex items-center mb-6">
                        <span class="font-manrope mr-2 text-6xl font-semibold text-indigo-600">$100</span>
                    ...
                    <a>
                        ...
                        'action' => route('subscribe.checkTrial'),
                        'plan' => 'yearly',
                        'buttonText' => 'Subscribe yearly',
                        'btnClass' => 'py-2.5 px-5 bg-indigo-600 shadow-sm rounded-full transition-all duration-500 text-base text-white font-semibold text-center w-fit block mx-auto hover:bg-indigo-700'
                        ]) @endcomponent
                    </a>
                    <!--List End-->
                </div>
            ...
            <div class="flex flex-col mx-auto max-w-sm text-gray-900 rounded-2xl bg-gray-50 p-6 xl:py-9 xl:px-12 transition-all duration-500 hover:bg-gray-100">
                ...
                <div class="flex items-center mb-6">
                    <span class="font-manrope mr-2 text-6xl font-semibold">$13</span>
                    <span class="text-xl text-gray-500 ">/ month</span>
                </div>
                <!--List-->
                <ul class="mb-12 space-y-6 text-left text-lg text-gray-500">
